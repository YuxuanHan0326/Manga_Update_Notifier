...
def test_build_notification_event_repairs_mojibake_titles():
    event = build_notification_event(
        source_code="copymanga",
        subscription_id=1,
        item_id="haizeiwang",
        ...
        source_item_url="https://www.mangacopy.com/comic/haizeiwang",
        update_id="u1",
        update_title=_garbled_utf8("第1176话"),
        update_url="https://www.mangacopy.com/comic/haizeiwang/chapter/1176",
        detected_at=datetime.now(UTC),
        dedupe_key="copymanga:1:u1",
        timezone_name="UTC",
    )
    assert event["subscription"]["item_title"] == "海贼王"
    assert event["update"]["update_title"] == "第1176话"
